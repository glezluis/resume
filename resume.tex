...
\usepackage{bbding,pifont,graphicx} 
...
\newcommand{\resheading}[1]{{ \Large  \vspace{-27pt}\parashade[.9]{sharpcorners}{\textbf{\color{blue}#1 \vphantom{p\^{E}}}} \vspace{-28pt}}}
...
\textbf{\LARGE Luis Manuel Gonzalez}  & (714) 675-4372\\
10862 Date Street &  luismg@csu.fullerton.edu \\
Stanton CA, 90680 \hspace{120pt} & \textbf{\tiny click here}\scalebox{1.5}{\raisebox{-0.6ex}{\ding{43}}}\href{https://github.com/glezluis}{github.com/glezluis}
\end{tabular*}
...
\begin{description}
\item[Languages:]
C/C++, python, OCaml, \LaTeX, Matlab, x86/Arm asm., django, React, HTML, CSS, SQL
\item[Workflow:]
...
\begin{itemize}
\item
	\ressubheading{Amazon Air}{Moreno Valley, Ca}{FC Associate}{November 2021 - Present}
	\begin{itemize}
		\resitem{Amazon Air associate responsible for unloading/loading packages into containers for aircraft}
 		\resitem{critical roles trained for include waterspider, splitter, and hydraulic box dumper}
	\end{itemize}
...
\begin{itemize}
\item
	\ressubheading{\scalebox{1.5}{\raisebox{-0.6ex}{\ding{43}}} \href{https://github.com/glezluis/cachetravel}{cacheanaheim.com}}{}{Website for Cache Travel Anaheim}{}
	\begin{itemize}
...
\rightline{\textbf{\small made with \href{https://www.latex-project.org/}{\LaTeX}}}
\end{document}
